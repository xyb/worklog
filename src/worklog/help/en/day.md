...
---
`wl day [date]` reproduces one day (default today): the day's header at the top — each line
with its own marker (🎯 goal · 📝 recap · 📅 this week · ⭐ this month), a goal that names
